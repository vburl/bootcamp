...
urlpatterns = patterns('',
    ...
    url(r'^(?P<username>[^/]+)/feed/$', 'bootcamp.core.views.user_feed', name='user_feed'),
    url(r'^(?P<username>[^/]+)/likes/$', 'bootcamp.core.views.user_likes', name='user_likes'),
    url(r'^(?P<username>[^/]+)/articles/$', 'bootcamp.core.views.user_articles', name='user_articles'),
    url(r'^(?P<username>[^/]+)/favorites/$', 'bootcamp.core.views.user_favorites', name='user_favorites'),
    url(r'^(?P<username>[^/]+)/questions/$', 'bootcamp.core.views.user_questions', name='user_questions'),
    url(r'^(?P<username>[^/]+)/answers/$', 'bootcamp.core.views.user_answers', name='user_answers'),
